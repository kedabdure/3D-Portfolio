...
const DeveloperRoom = (props) => {
  const { nodes, materials } = useGLTF('/models/developer/gaming-desk.glb')
  const screenTexture = useTexture("/textures/code-screenshot.png")
  return (
...
useGLTF.preload('/models/developer/gaming-desk.glb')
